function migrationFunction(migration, context) {
    ...
    const blogContent = blog.createField("content");
    blogContent
        .name("Content")
        .type("RichText")
        .localized(false)
    ...
    blog.changeFieldControl("description", "builtin", "singleLine")
    blog.changeFieldControl("content", "builtin", "richTextEditor")
}
